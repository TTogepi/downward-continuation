...
%%
function [f_con]=FFTDC_main1(f,expand,Cell,z,cof,i_taylor)
...
%%
[mnew,nnew]=size(fexp);
filter = zeros(mnew,nnew);
Fourier_fcon =  zeros(mnew,nnew);
%,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,     
...
for i = 1 : i_taylor
    ...
    Fourier_fcon= Fourier_fcon + U.* filter .* (K .* z) .^ (i-1) ./ factorial(i-1);
