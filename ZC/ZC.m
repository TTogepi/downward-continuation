...
%
%      ZC('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ZC.M with the given input arguments.
%
%      ZC('Property','Value',...) creates a new ZC or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ZC_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ZC_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 18-Apr-2022 13:23:54
...
% varargin   command line arguments to ZC (see VARARGIN)
...
function varargout = ZC_OutputFcn(hObject, eventdata, handles) 
...
k = round(str2num(get(handles.edit5,'string')));

[expectation] =  ZC_main(f, expand,Cell, h,k);
